...
import library.config.filter.JWTAuthorizationFilter;
import library.config.handler.AuthenticationAccessDeniedHandler;
import library.config.handler.CustomAuthenticationFailureHandler;
import library.config.handler.CustomAuthenticationSuccessHandler;
import library.config.handler.SimpleAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                //.antMatchers("/sys/user/registerUser").permitAll()
